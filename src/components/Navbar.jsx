      ...
      >
        <div className="navbar">
          <div className="navbar-start">
            ...
            <Link to="/" className="text-2xl font-bold cursor-pointer mr-2">bookStore</Link>
          </div>
              ...
              <form onSubmit={handleSearch}>
                <div className="relative">
                  <input
                    ...
                    className="pl-10 pr-3 py-2 rounded-md border outline-none dark:bg-slate-900 dark:text-white"
                    placeholder="Search"
                  />
